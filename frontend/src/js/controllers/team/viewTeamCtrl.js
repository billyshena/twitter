...
angular.module('app.controllers.team.view', []).controller('viewTeamCtrl', [
    '$scope', '$sailsSocket', '$state', 'Logger', 'UserService', 'team',
    function ($scope, $sailsSocket, $state, Logger, UserService, team) {
